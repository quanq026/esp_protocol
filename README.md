...
---
# Bài tập 1: Blynk
Dự án điều khiển **1 đèn NeoPixel** trên ESP32-S3 qua Blink dashbroad.
Hỗ trợ:
- Bật/tắt LED bằng nút trên Blink.
- 
## Phần cứng yêu cầu
- ESP32 (trong dự án này dùng esp32-s3 để điều khiển led onborad GPIO48)
...
### Cách sử dụng
1. Tạo các biến Virtual Pin (v1), đặt tên và chọn kiểu dữ liệu tương ứng để sử dụng trong quá trình lập trình code trên ESP32.
2. Thêm công tắc cho dashbroad.
